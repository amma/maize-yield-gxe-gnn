...
def main():
    parser = argparse.ArgumentParser(description="Test Architecture C")
    parser.add_argument("--model-path", default="results/arch_c/best_model.pt")
    ...
    parser.add_argument("--outdir", default="results/arch_c_test")
